namespace MVCHomeWork.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_CustStatDataRepository Getvw_CustStatDataRepository()
		{
			var repository = new vw_CustStatDataRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_CustStatDataRepository Getvw_CustStatDataRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_CustStatDataRepository();
